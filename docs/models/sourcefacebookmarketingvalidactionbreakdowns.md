...
```python
from airbyte_api.models import SourceFacebookMarketingValidActionBreakdowns

value = SourceFacebookMarketingValidActionBreakdowns.ACTION_CANVAS_COMPONENT_NAME
```

...
res = s.public_sources.create_source(request=models.SourceCreateRequest(
...
res = s.public_sources.delete_source(request=api.DeleteSourceRequest(
    source_id='<value>',
))
...
res = s.public_sources.get_source(request=api.GetSourceRequest(
    source_id='<value>',
))
...
res = s.public_sources.initiate_o_auth(request=models.InitiateOauthRequest(
...
res = s.public_sources.list_sources(request=api.ListSourcesRequest(
    workspace_ids=[
        'd',
        'f',
        '0',
...
res = s.public_sources.patch_source(request=api.PatchSourceRequest(
    source_id='<value>',
...
res = s.public_sources.put_source(request=api.PutSourceRequest(
    source_id='<value>',

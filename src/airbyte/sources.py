...
class Sources:
    ...
    def delete_source(self, request: operations.DeleteSourceRequest) -> operations.DeleteSourceResponse:
        ...
        res = operations.DeleteSourceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def initiate_o_auth(self, request: shared.InitiateOauthRequest) -> operations.InitiateOAuthResponse:
        ...
        res = operations.InitiateOAuthResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_sources(self, request: operations.ListSourcesRequest) -> operations.ListSourcesResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListSourcesRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ListSourcesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def patch_source(self, request: operations.PatchSourceRequest) -> operations.PatchSourceResponse:
        ...
        res = operations.PatchSourceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def put_source(self, request: operations.PutSourceRequest) -> operations.PutSourceResponse:
        ...
        res = operations.PutSourceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)

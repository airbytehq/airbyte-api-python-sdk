...
class Jobs:
    ...
    def cancel_job(self, request: operations.CancelJobRequest) -> operations.CancelJobResponse:
        ...
        res = operations.CancelJobResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def create_job(self, request: shared.JobCreateRequest) -> operations.CreateJobResponse:
        ...
        res = operations.CreateJobResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_job(self, request: operations.GetJobRequest) -> operations.GetJobResponse:
        ...
        res = operations.GetJobResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_jobs(self, request: operations.ListJobsRequest) -> operations.ListJobsResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListJobsRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ListJobsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)

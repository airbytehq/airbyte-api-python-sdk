...
class BigqueryDenormalized(str, Enum):
    BIGQUERY_DENORMALIZED = 'bigquery-denormalized'

class DestinationBigqueryDenormalizedCredentialType(str, Enum):
    HMAC_KEY = 'HMAC_KEY'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class DestinationBigqueryDenormalizedHMACKey:
    ...
    CREDENTIAL_TYPE: Final[DestinationBigqueryDenormalizedCredentialType] = dataclasses.field(default=DestinationBigqueryDenormalizedCredentialType.HMAC_KEY, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credential_type') }})
...
class DestinationBigqueryDenormalizedMethod(str, Enum):
...
class GCSStaging:
    ...
    credential: Union[DestinationBigqueryDenormalizedHMACKey] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credential') }})
    r"""An HMAC key is a type of credential and can be associated with a service account or a user account in Cloud Storage. Read more <a href=\\"https://cloud.google.com/storage/docs/authentication/hmackeys\\">here</a>."""
    ...
    METHOD: Final[DestinationBigqueryDenormalizedMethod] = dataclasses.field(default=DestinationBigqueryDenormalizedMethod.GCS_STAGING, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('method') }})
...
class DestinationBigqueryDenormalized:
    ...
    DESTINATION_TYPE: Final[BigqueryDenormalized] = dataclasses.field(default=BigqueryDenormalized.BIGQUERY_DENORMALIZED, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinationType') }})
    ...
    dataset_location: Optional[DatasetLocation] = dataclasses.field(default=DatasetLocation.US, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataset_location'), 'exclude': lambda f: f is None }})
    r"""The location of the dataset. Warning: Changes made after creation will not be applied. The default \\"US\\" value is used if not set explicitly. Read more <a href=\\"https://cloud.google.com/bigquery/docs/locations\\">here</a>."""
    loading_method: Optional[Union[StandardInserts, GCSStaging]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('loading_method'), 'exclude': lambda f: f is None }})
    r"""Loading method used to send select the way data will be uploaded to BigQuery. <br/><b>Standard Inserts</b> - Direct uploading using SQL INSERT statements. This method is extremely inefficient and provided only for quick testing. In almost all cases, you should use staging. <br/><b>GCS Staging</b> - Writes large batches of records to a file, uploads the file to GCS, then uses <b>COPY INTO table</b> to upload the file. Recommended for most workloads for better speed and scalability. Read more about GCS Staging <a href=\\"https://docs.airbyte.com/integrations/destinations/bigquery#gcs-staging\\">here</a>."""

...
class SourceSlackAuthenticationMechanismAPIToken:
    ...
    OPTION_TITLE: Final[str] = dataclasses.field(default='API Token Credentials', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('option_title') }})
...
class SourceSlackAuthenticationMechanismSignInViaSlackOAuth:
    ...
    OPTION_TITLE: Final[str] = dataclasses.field(default='Default OAuth2.0 authorization', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('option_title') }})
...
class SourceSlack:
    ...
    SOURCE_TYPE: Final[str] = dataclasses.field(default='slack', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

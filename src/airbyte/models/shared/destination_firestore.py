...
class DestinationFirestore:
    ...
    DESTINATION_TYPE: Final[DestinationFirestoreFirestore] = dataclasses.field(default=DestinationFirestoreFirestore.FIRESTORE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinationType') }})

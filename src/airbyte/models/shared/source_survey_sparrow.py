...
class SourceSurveySparrowBaseURLGlobalAccount:
    ...
    url_base: Optional[SourceSurveySparrowBaseURLGlobalAccountURLBase] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('url_base'), 'exclude': lambda f: f is None }})
...
class SourceSurveySparrowBaseURLEUBasedAccount:
    r"""Is your account location is EU based? If yes, the base url to retrieve data will be different."""
    url_base: Optional[SourceSurveySparrowBaseURLEUBasedAccountURLBase] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('url_base'), 'exclude': lambda f: f is None }})

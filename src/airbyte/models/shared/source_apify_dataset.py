...
class SourceApifyDataset:
    ...
    SOURCE_TYPE: Final[SourceApifyDatasetApifyDataset] = dataclasses.field(default=SourceApifyDatasetApifyDataset.APIFY_DATASET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

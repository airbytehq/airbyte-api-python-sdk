...
class SourceSpacexAPI:
    ...
    SOURCE_TYPE: Final[Optional[str]] = dataclasses.field(default='spacex-api', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType'), 'exclude': lambda f: f is None }})

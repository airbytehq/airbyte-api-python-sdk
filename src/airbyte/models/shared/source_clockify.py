...
class SourceClockify:
    ...
    r"""WorkSpace Id"""
    SOURCE_TYPE: Final[SourceClockifyClockify] = dataclasses.field(default=SourceClockifyClockify.CLOCKIFY, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

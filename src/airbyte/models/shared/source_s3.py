...
class SourceS3FileBasedStreamConfig:
    ...
    validation_policy: Optional[SourceS3FileBasedStreamConfigValidationPolicy] = dataclasses.field(default=SourceS3FileBasedStreamConfigValidationPolicy.EMIT_RECORD, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validation_policy'), 'exclude': lambda f: f is None }})
    r"""The name of the validation policy that dictates sync behavior when a record does not adhere to the stream schema."""

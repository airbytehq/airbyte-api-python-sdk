...
class SourceShopifyOauthCredentialsOAuth20AuthMethod(str, Enum):
    OAUTH2_0 = 'oauth2.0'
...
class SourceShopifyOauthCredentialsOAuth20:
    r"""OAuth2.0"""
    auth_method: SourceShopifyOauthCredentialsOAuth20AuthMethod = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_method') }})
...
class SourceShopifyOauthCredentialsAPIPasswordAuthMethod(str, Enum):
...
@dataclasses.dataclass
class SourceShopifyOauthCredentialsAPIPassword:
    r"""API Password Auth"""
    ...
    auth_method: SourceShopifyOauthCredentialsAPIPasswordAuthMethod = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_method') }})
    


class SourceShopifyOauthShopifyOauth(str, Enum):
...
class SourceShopifyOauth:
    ...
    source_type: SourceShopifyOauthShopifyOauth = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

...
class DestinationSnowflakeAuthorizationMethodUsernameAndPassword:
    ...
    auth_type: Optional[DestinationSnowflakeAuthorizationMethodUsernameAndPasswordAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
...
class DestinationSnowflakeAuthorizationMethodKeyPairAuthentication:
    ...
    auth_type: Optional[DestinationSnowflakeAuthorizationMethodKeyPairAuthenticationAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
...
class DestinationSnowflakeAuthorizationMethodOAuth20:
    ...
    auth_type: Optional[DestinationSnowflakeAuthorizationMethodOAuth20AuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})

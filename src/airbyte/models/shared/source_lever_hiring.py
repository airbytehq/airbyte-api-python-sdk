...
class SourceLeverHiringAuthenticationMechanismAuthenticateViaLeverAPIKey:
    ...
    auth_type: Optional[SourceLeverHiringAuthenticationMechanismAuthenticateViaLeverAPIKeyAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
...
class SourceLeverHiringAuthenticationMechanismAuthenticateViaLeverOAuth:
    ...
    auth_type: Optional[SourceLeverHiringAuthenticationMechanismAuthenticateViaLeverOAuthAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})

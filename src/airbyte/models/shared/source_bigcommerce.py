...
class SourceBigcommerce:
    ...
    SOURCE_TYPE: Final[Bigcommerce] = dataclasses.field(default=Bigcommerce.BIGCOMMERCE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

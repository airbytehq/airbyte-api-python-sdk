...
class SourceCloseCom:
    ...
    SOURCE_TYPE: Final[SourceCloseComCloseCom] = dataclasses.field(default=SourceCloseComCloseCom.CLOSE_COM, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

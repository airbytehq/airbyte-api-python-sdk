...
class SourceAzureTable:
    ...
    SOURCE_TYPE: Final[SourceAzureTableAzureTable] = dataclasses.field(default=SourceAzureTableAzureTable.AZURE_TABLE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

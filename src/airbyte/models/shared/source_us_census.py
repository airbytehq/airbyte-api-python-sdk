...
class SourceUsCensus:
    ...
    SOURCE_TYPE: Final[SourceUsCensusUsCensus] = dataclasses.field(default=SourceUsCensusUsCensus.US_CENSUS, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

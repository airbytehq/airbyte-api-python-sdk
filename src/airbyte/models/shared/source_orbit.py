...
class SourceOrbit:
    ...
    SOURCE_TYPE: Final[SourceOrbitOrbit] = dataclasses.field(default=SourceOrbitOrbit.ORBIT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

...
class SourceTwitter:
    ...
    SOURCE_TYPE: Final[SourceTwitterTwitter] = dataclasses.field(default=SourceTwitterTwitter.TWITTER, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

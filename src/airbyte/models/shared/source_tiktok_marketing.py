...
class SourceTiktokMarketingAuthenticationMethodSandboxAccessToken:
    ...
    auth_type: Optional[SourceTiktokMarketingAuthenticationMethodSandboxAccessTokenAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
...
class SourceTiktokMarketingAuthenticationMethodOAuth20:
    ...
    auth_type: Optional[SourceTiktokMarketingAuthenticationMethodOAuth20AuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})

...
class SourceMssqlReplicationMethodScanChangesWithUserDefinedCursorMethod(str, Enum):
    STANDARD = 'STANDARD'
...
class SourceMssqlReplicationMethodScanChangesWithUserDefinedCursor:
    ...
    method: SourceMssqlReplicationMethodScanChangesWithUserDefinedCursorMethod = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('method') }})
    


class SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDCDataToSync(str, Enum):
...
class SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDCMethod(str, Enum):
    CDC = 'CDC'

class SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDCInitialSnapshotIsolationLevel(str, Enum):
...
@dataclasses.dataclass
class SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDC:
    ...
    method: SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDCMethod = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('method') }})
    data_to_sync: Optional[SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDCDataToSync] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data_to_sync'), 'exclude': lambda f: f is None }})
    r"""What data should be synced under the CDC. \\"Existing and New\\" will read existing data as a snapshot, and sync new changes through CDC. \\"New Changes Only\\" will skip the initial snapshot, and only sync new changes through CDC."""
    ...
    snapshot_isolation: Optional[SourceMssqlReplicationMethodReadChangesUsingChangeDataCaptureCDCInitialSnapshotIsolationLevel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('snapshot_isolation'), 'exclude': lambda f: f is None }})
    r"""Existing data in the database are synced through an initial snapshot. This parameter controls the isolation level that will be used during the initial snapshotting. If you choose the \\"Snapshot\\" level, you must enable the <a href=\\"https://docs.microsoft.com/en-us/dotnet/framework/data/adonet/sql/snapshot-isolation-in-sql-server\\">snapshot isolation mode</a> on the database."""

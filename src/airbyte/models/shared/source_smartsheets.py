...
class SourceSmartsheetsAuthorizationMethodAPIAccessToken:
    ...
    auth_type: Optional[SourceSmartsheetsAuthorizationMethodAPIAccessTokenAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
...
class SourceSmartsheetsAuthorizationMethodOAuth20:
    ...
    auth_type: Optional[SourceSmartsheetsAuthorizationMethodOAuth20AuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})

...
class DestinationCumulio:
    ...
    DESTINATION_TYPE: Final[DestinationCumulioCumulio] = dataclasses.field(default=DestinationCumulioCumulio.CUMULIO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinationType') }})

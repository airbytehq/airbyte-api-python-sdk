...
class SourceMongodbSchemasInstanceTypeInstance(str, Enum):
    ATLAS = 'atlas'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceMongodbMongoDBAtlas:
    ...
    INSTANCE: Final[SourceMongodbSchemasInstanceTypeInstance] = dataclasses.field(default=SourceMongodbSchemasInstanceTypeInstance.ATLAS, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('instance') }})
    additional_properties: Optional[Dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'exclude': lambda f: f is None }})
    


class SourceMongodbSchemasInstance(str, Enum):
    REPLICA = 'replica'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceMongodbReplicaSet:
    r"""The MongoDb instance to connect to. For MongoDB Atlas and Replica Set TLS connection is used by default."""
    ...
    INSTANCE: Final[SourceMongodbSchemasInstance] = dataclasses.field(default=SourceMongodbSchemasInstance.REPLICA, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('instance') }})
...
class SourceMongodbInstance(str, Enum):
    STANDALONE = 'standalone'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceMongodbStandaloneMongoDbInstance:
    r"""The MongoDb instance to connect to. For MongoDB Atlas and Replica Set TLS connection is used by default."""
    host: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('host') }})
    r"""The host name of the Mongo database."""
    INSTANCE: Final[SourceMongodbInstance] = dataclasses.field(default=SourceMongodbInstance.STANDALONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('instance') }})
...
class SourceMongodb:
    ...
    instance_type: Optional[Union[SourceMongodbStandaloneMongoDbInstance, SourceMongodbReplicaSet, SourceMongodbMongoDBAtlas]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('instance_type'), 'exclude': lambda f: f is None }})
    r"""The MongoDb instance to connect to. For MongoDB Atlas and Replica Set TLS connection is used by default."""

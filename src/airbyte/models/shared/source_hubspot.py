...
class SourceHubspotAuthenticationPrivateApp:
    ...
    credentials_title: SourceHubspotAuthenticationPrivateAppAuthType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials_title') }})
    r"""Name of the credentials set"""
...
class SourceHubspotAuthenticationOAuth:
    ...
    credentials_title: SourceHubspotAuthenticationOAuthAuthType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials_title') }})
    r"""Name of the credentials"""

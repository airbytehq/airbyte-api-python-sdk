...
class SourceHubspotAuthenticationPrivateApp:
    ...
    CREDENTIALS_TITLE: Final[str] = dataclasses.field(default='Private App Credentials', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials_title') }})
...
class SourceHubspotAuthenticationOAuth:
    ...
    CREDENTIALS_TITLE: Final[str] = dataclasses.field(default='OAuth Credentials', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials_title') }})
...
class SourceHubspot:
    ...
    SOURCE_TYPE: Final[str] = dataclasses.field(default='hubspot', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

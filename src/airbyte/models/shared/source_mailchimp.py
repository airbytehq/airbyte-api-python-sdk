...
class SourceMailchimpAuthenticationAPIKey:
    ...
    auth_type: SourceMailchimpAuthenticationAPIKeyAuthType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type') }})
...
class SourceMailchimpAuthenticationOAuth20:
    ...
    auth_type: SourceMailchimpAuthenticationOAuth20AuthType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type') }})

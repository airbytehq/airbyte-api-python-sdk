...
class SourceMailchimpAuthenticationAPIKey:
    ...
    AUTH_TYPE: Final[str] = dataclasses.field(default='apikey', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type') }})
...
class SourceMailchimp:
    ...
    SOURCE_TYPE: Final[str] = dataclasses.field(default='mailchimp', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

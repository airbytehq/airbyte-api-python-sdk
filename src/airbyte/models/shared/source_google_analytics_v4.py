...
class SourceGoogleAnalyticsV4SchemasAuthType(str, Enum):
    SERVICE = 'Service'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGoogleAnalyticsV4ServiceAccountKeyAuthentication:
    ...
    AUTH_TYPE: Final[Optional[SourceGoogleAnalyticsV4SchemasAuthType]] = dataclasses.field(default=SourceGoogleAnalyticsV4SchemasAuthType.SERVICE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
    


class SourceGoogleAnalyticsV4AuthType(str, Enum):
    CLIENT = 'Client'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGoogleAnalyticsV4AuthenticateViaGoogleOauth:
    r"""Credentials for the service"""
    ...
    AUTH_TYPE: Final[Optional[SourceGoogleAnalyticsV4AuthType]] = dataclasses.field(default=SourceGoogleAnalyticsV4AuthType.CLIENT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})
...
class SourceGoogleAnalyticsV4:
    ...
    credentials: Optional[Union[SourceGoogleAnalyticsV4AuthenticateViaGoogleOauth, SourceGoogleAnalyticsV4ServiceAccountKeyAuthentication]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials'), 'exclude': lambda f: f is None }})
    r"""Credentials for the service"""

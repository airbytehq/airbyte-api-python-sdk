...
class SourceSenseforce:
    ...
    SOURCE_TYPE: Final[SourceSenseforceSenseforce] = dataclasses.field(default=SourceSenseforceSenseforce.SENSEFORCE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

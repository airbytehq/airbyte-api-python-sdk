...
class Destinations:
    ...
    def delete_destination(self, request: operations.DeleteDestinationRequest) -> operations.DeleteDestinationResponse:
        ...
        res = operations.DeleteDestinationResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_destinations(self, request: operations.ListDestinationsRequest) -> operations.ListDestinationsResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListDestinationsRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ListDestinationsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def patch_destination(self, request: operations.PatchDestinationRequest) -> operations.PatchDestinationResponse:
        ...
        res = operations.PatchDestinationResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def put_destination(self, request: operations.PutDestinationRequest) -> operations.PutDestinationResponse:
        ...
        res = operations.PutDestinationResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)

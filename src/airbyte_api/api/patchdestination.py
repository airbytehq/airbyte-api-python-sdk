...
from ..models import destinationpatchrequest as models_destinationpatchrequest
...
class PatchDestinationRequest:
    ...
    destination_patch_request: Optional[models_destinationpatchrequest.DestinationPatchRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})

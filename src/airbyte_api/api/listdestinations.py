...
from ..models import destinationsresponse as models_destinationsresponse
...
class ListDestinationsResponse:
    ...
    destinations_response: Optional[models_destinationsresponse.DestinationsResponse] = dataclasses.field(default=None)

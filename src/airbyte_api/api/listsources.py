...
from ..models import sourcesresponse as models_sourcesresponse
...
class ListSourcesResponse:
    ...
    sources_response: Optional[models_sourcesresponse.SourcesResponse] = dataclasses.field(default=None)

...
from airbyte_api.models import workspacesresponse as models_workspacesresponse
...
class ListWorkspacesResponseTypedDict(TypedDict):
    ...
    workspaces_response: NotRequired[
        models_workspacesresponse.WorkspacesResponseTypedDict
    ]
...
class ListWorkspacesResponse(BaseModel):
    ...
    workspaces_response: Optional[models_workspacesresponse.WorkspacesResponse] = None
    r"""Successful operation"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["WorkspacesResponse"])
        serialized = handler(self)
        m = {}

...
class Csv:
    ...
    FILETYPE: Final[Optional[Filetype]] = dataclasses.field(default=Filetype.CSV, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
SourceS3FileFormat = Union['Csv', 'Parquet', 'Avro', 'Jsonl']
...
SourceS3Format = Union['SourceS3AvroFormat', 'SourceS3CSVFormat', 'SourceS3JsonlFormat', 'SourceS3ParquetFormat', 'SourceS3DocumentFileTypeFormatExperimental']
...
class SourceS3:
    ...
    format: Optional[SourceS3FileFormat] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})

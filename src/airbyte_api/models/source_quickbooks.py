...
class SourceQuickbooks:
    ...
    AUTH_TYPE: Final[Optional[AuthType]] = dataclasses.field(default=AuthType.OAUTH2_0, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_type'), 'exclude': lambda f: f is None }})

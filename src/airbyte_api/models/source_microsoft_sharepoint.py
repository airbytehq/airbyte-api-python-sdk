...
class SourceMicrosoftSharepointDocumentFileTypeFormatExperimental:
    ...
    processing: Optional[Union[SourceMicrosoftSharepointLocal]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processing'), 'exclude': lambda f: f is None }})
...
class SourceMicrosoftSharepointCSVFormat:
    ...
    header_definition: Optional[Union[SourceMicrosoftSharepointFromCSV, SourceMicrosoftSharepointAutogenerated, SourceMicrosoftSharepointUserProvided]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('header_definition'), 'exclude': lambda f: f is None }})
...
class SourceMicrosoftSharepoint:
    ...
    """
    credentials: Union[SourceMicrosoftSharepointAuthenticateViaMicrosoftOAuth, SourceMicrosoftSharepointServiceKeyAuthentication] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials') }})

...
from .sourcepatchrequest import SourcePatchRequest
...
class PatchSourceRequest:
    ...
    source_patch_request: Optional[SourcePatchRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})

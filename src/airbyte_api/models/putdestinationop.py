...
from .destinationputrequest import DestinationPutRequest
...
class PutDestinationRequest:
    ...
    destination_put_request: Optional[DestinationPutRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})

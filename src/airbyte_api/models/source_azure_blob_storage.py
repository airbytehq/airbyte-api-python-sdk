...
@dataclasses.dataclass
class ExcelFormat:
    FILETYPE: Final[Optional[SourceAzureBlobStorageSchemasStreamsFormatFormatFiletype]] = dataclasses.field(default=SourceAzureBlobStorageSchemasStreamsFormatFormatFiletype.EXCEL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
class AvroFormat:
    ...
    FILETYPE: Final[Optional[Filetype]] = dataclasses.field(default=Filetype.AVRO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
Format = Union[AvroFormat, CSVFormat, JsonlFormat, ParquetFormat, UnstructuredDocumentFormat, ExcelFormat]

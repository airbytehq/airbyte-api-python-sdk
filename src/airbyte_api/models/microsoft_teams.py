...
class MicrosoftTeamsCredentialsTypedDict(TypedDict):
...
class MicrosoftTeamsTypedDict(TypedDict):
    credentials: NotRequired[MicrosoftTeamsCredentialsTypedDict]


class MicrosoftTeams(BaseModel):

...
class GoogleAdsCredentialsTypedDict(TypedDict):
    ...
    developer_token: NotRequired[str]
...
class GoogleAdsCredentials(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["client_id", "client_secret", "developer_token"])
...
class GoogleAdsTypedDict(TypedDict):
    credentials: NotRequired[GoogleAdsCredentialsTypedDict]


class GoogleAds(BaseModel):

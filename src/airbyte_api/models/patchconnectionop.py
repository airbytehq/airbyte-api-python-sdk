...
from .connectionpatchrequest import ConnectionPatchRequest
...
class PatchConnectionRequest:
    connection_patch_request: ConnectionPatchRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})

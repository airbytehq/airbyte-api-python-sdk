...
class MicrosoftOnedriveCredentialsTypedDict(TypedDict):
...
class MicrosoftOnedriveTypedDict(TypedDict):
    credentials: NotRequired[MicrosoftOnedriveCredentialsTypedDict]

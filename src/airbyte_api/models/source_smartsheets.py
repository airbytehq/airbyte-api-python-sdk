...
class APIAccessTokenTypedDict(TypedDict):
    ...
    auth_type: SourceSmartsheetsSchemasAuthType
...
class APIAccessToken(BaseModel):
    ...
    AUTH_TYPE: Annotated[
        Annotated[
            Optional[SourceSmartsheetsSchemasAuthType],
            AfterValidator(
                validate_const(SourceSmartsheetsSchemasAuthType.ACCESS_TOKEN)
            ),
        ],
        pydantic.Field(alias="auth_type"),
    ] = SourceSmartsheetsSchemasAuthType.ACCESS_TOKEN
...
class SourceSmartsheetsOAuth20TypedDict(TypedDict):
    ...
    auth_type: SourceSmartsheetsAuthType
...
class SourceSmartsheetsOAuth20(BaseModel):
    ...
    AUTH_TYPE: Annotated[
        Annotated[
            Optional[SourceSmartsheetsAuthType],
            AfterValidator(validate_const(SourceSmartsheetsAuthType.OAUTH2_0)),
        ],
        pydantic.Field(alias="auth_type"),
    ] = SourceSmartsheetsAuthType.OAUTH2_0

...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceMicrosoftOnedriveDocumentFileTypeFormatExperimental:
    ...
    processing: Optional[Union[SourceMicrosoftOnedriveLocal]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processing'), 'exclude': lambda f: f is None }})
...
class SourceMicrosoftOnedriveCSVFormat:
    ...
    header_definition: Optional[Union[SourceMicrosoftOnedriveFromCSV, SourceMicrosoftOnedriveAutogenerated, SourceMicrosoftOnedriveUserProvided]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('header_definition'), 'exclude': lambda f: f is None }})
...
class SourceMicrosoftOnedriveFileBasedStreamConfig:
    format: Union[SourceMicrosoftOnedriveAvroFormat, SourceMicrosoftOnedriveCSVFormat, SourceMicrosoftOnedriveJsonlFormat, SourceMicrosoftOnedriveParquetFormat, SourceMicrosoftOnedriveDocumentFileTypeFormatExperimental] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format') }})

...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceSftpBulkDocumentFileTypeFormatExperimental:
    ...
    processing: Optional[Union[SourceSftpBulkLocal, ViaAPI]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processing'), 'exclude': lambda f: f is None }})
...
class SourceSftpBulkCSVFormat:
    ...
    header_definition: Optional[Union[SourceSftpBulkFromCSV, SourceSftpBulkAutogenerated, SourceSftpBulkUserProvided]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('header_definition'), 'exclude': lambda f: f is None }})
...
class SourceSftpBulkFileBasedStreamConfig:
    format: Union[SourceSftpBulkAvroFormat, SourceSftpBulkCSVFormat, SourceSftpBulkJsonlFormat, SourceSftpBulkParquetFormat, SourceSftpBulkDocumentFileTypeFormatExperimental] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format') }})
...
class SourceSftpBulk:
    ...
    """
    credentials: Union[AuthenticateViaPassword, AuthenticateViaPrivateKey] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials') }})

...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGcsAuthenticateViaGoogleOAuth:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGcsExcelFormat:
    FILETYPE: Final[Optional[SourceGcsSchemasStreamsFormatFormat6Filetype]] = dataclasses.field(default=SourceGcsSchemasStreamsFormatFormat6Filetype.EXCEL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
class ViaAPI:
    ...
    MODE: Final[Optional[SourceGcsSchemasMode]] = dataclasses.field(default=SourceGcsSchemasMode.API, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode'), 'exclude': lambda f: f is None }})
    parameters: Optional[List[APIParameterConfigModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parameters'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGcsLocal:
    r"""Process files locally, supporting `fast` and `ocr` modes. This is the default option."""
    MODE: Final[Optional[SourceGcsMode]] = dataclasses.field(default=SourceGcsMode.LOCAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGcsUnstructuredDocumentFormat:
    r"""Extract text from document formats (.pdf, .docx, .md, .pptx) and emit as one record per file."""
    FILETYPE: Final[Optional[SourceGcsSchemasStreamsFormatFormatFiletype]] = dataclasses.field(default=SourceGcsSchemasStreamsFormatFormatFiletype.UNSTRUCTURED, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
    processing: Optional[SourceGcsProcessing] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processing'), 'exclude': lambda f: f is None }})
    ...
    strategy: Optional[SourceGcsParsingStrategy] = dataclasses.field(default=SourceGcsParsingStrategy.AUTO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('strategy'), 'exclude': lambda f: f is None }})
    r"""The strategy used to parse documents. `fast` extracts text directly from the document which doesn't work for all files. `ocr_only` is more reliable, but slower. `hi_res` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode. See the unstructured.io documentation for more details: https://unstructured-io.github.io/unstructured/core/partition.html#partition-pdf"""
...
class SourceGcsParquetFormat:
    ...
    FILETYPE: Final[Optional[SourceGcsSchemasStreamsFormatFiletype]] = dataclasses.field(default=SourceGcsSchemasStreamsFormatFiletype.PARQUET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGcsJsonlFormat:
    FILETYPE: Final[Optional[SourceGcsSchemasStreamsFiletype]] = dataclasses.field(default=SourceGcsSchemasStreamsFiletype.JSONL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
class SourceGcsCSVFormat:
    ...
    FILETYPE: Final[Optional[SourceGcsSchemasFiletype]] = dataclasses.field(default=SourceGcsSchemasFiletype.CSV, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
    header_definition: Optional[SourceGcsCSVHeaderDefinition] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('header_definition'), 'exclude': lambda f: f is None }})
...
class SourceGcsAvroFormat:
    ...
    FILETYPE: Final[Optional[SourceGcsFiletype]] = dataclasses.field(default=SourceGcsFiletype.AVRO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filetype'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SourceGcsFileBasedStreamConfig:
    format: SourceGcsFormat = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format') }})
...
SourceGcsAuthentication = Union[SourceGcsAuthenticateViaGoogleOAuth, ServiceAccountAuthentication]

SourceGcsProcessing = Union[SourceGcsLocal, ViaAPI]

SourceGcsCSVHeaderDefinition = Union[SourceGcsFromCSV, SourceGcsAutogenerated, SourceGcsUserProvided]

SourceGcsFormat = Union[SourceGcsAvroFormat, SourceGcsCSVFormat, SourceGcsJsonlFormat, SourceGcsParquetFormat, SourceGcsUnstructuredDocumentFormat, SourceGcsExcelFormat]

...
class SourceSigmaComputing:
    ...
    SOURCE_TYPE: Final[SigmaComputing] = dataclasses.field(default=SigmaComputing.SIGMA_COMPUTING, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})

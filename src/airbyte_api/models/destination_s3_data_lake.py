...
class DestinationS3DataLakeRestCatalog:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class DestinationS3DataLakeGlueCatalog:
...
CatalogType = Union[NessieCatalog, DestinationS3DataLakeGlueCatalog, DestinationS3DataLakeRestCatalog]

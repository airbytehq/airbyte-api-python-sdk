...
class Failing:
    ...
    TEST_DESTINATION_TYPE: Final[Optional[DestinationDevNullSchemasTestDestinationTestDestinationType]] = dataclasses.field(default=DestinationDevNullSchemasTestDestinationTestDestinationType.FAILING, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test_destination_type'), 'exclude': lambda f: f is None }})
...
class Throttled:
    ...
    r"""Number of milli-second to pause in between records."""
    TEST_DESTINATION_TYPE: Final[Optional[DestinationDevNullSchemasTestDestinationType]] = dataclasses.field(default=DestinationDevNullSchemasTestDestinationType.THROTTLED, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test_destination_type'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class Silent:
    TEST_DESTINATION_TYPE: Final[Optional[DestinationDevNullTestDestinationType]] = dataclasses.field(default=DestinationDevNullTestDestinationType.SILENT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test_destination_type'), 'exclude': lambda f: f is None }})
...
class RandomSampling:
    ...
    r"""Max number of entries to log. This destination is for testing only. So it won't make sense to log infinitely. The maximum is 1,000 entries."""
...
class EveryNThEntry:
    ...
    nth_entry_to_log: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nth_entry_to_log') }})
...
class Logging:
    ...
    TEST_DESTINATION_TYPE: Final[Optional[TestDestinationType]] = dataclasses.field(default=TestDestinationType.LOGGING, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test_destination_type'), 'exclude': lambda f: f is None }})
